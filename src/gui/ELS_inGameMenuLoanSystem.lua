...
function ELS_inGameMenuLoanSystem.new(i18n, messageCenter)
    ...
    self.i18n = i18n
    self.name = "InGameMenuLoanSystem"
...
function ELS_inGameMenuLoanSystem:onGuiSetupFinished()
    logger:debug("ELS_inGameMenuLoanSystem:onGuiSetupFinished() called")
	ELS_inGameMenuLoanSystem:superClass().onGuiSetupFinished(self)
    logger:debug("ELS_inGameMenuLoanSystem:superClass() called")

    logger:debug("ELS_inGameMenuLoanSystem:onGuiSetupFinished()> Setting 'LoanTable' datasource . . .")
	self.loanTable:setDataSource(self)
	self.loanTable:setDelegate(self)
    logger:debug("ELS_inGameMenuLoanSystem:onGuiSetupFinished()> Done.")

    logger:debug("ELS_inGameMenuLoanSystem:onGuiSetupFinished()> Loading 'TakeLoanDialog' gui . . .")
    ...
    logger:debug("ELS_inGameMenuLoanSystem:onGuiSetupFinished()> Loading 'Special Redemption' gui . . .")
