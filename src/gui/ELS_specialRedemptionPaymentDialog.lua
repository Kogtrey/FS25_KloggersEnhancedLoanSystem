...
function ELS_specialRedemptionPaymentDialog:resetUI()
    ...
    self.restAmountField:setText(string.format("%s: %s", self.i18n:getText("els_ui_specialRedemptionPaymentRestAmount"), g_i18n:formatMoney(self.restAmount,0,true,true)))
